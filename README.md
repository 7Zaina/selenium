...
5- redigez une premiere classe (soustraction_positive), et un premier test junit (les classes du Test doivent imperativement etre nomée *Test.java ou *Tests.java), puis accedez au dossier cours (racine du projet), puis lancez le test avec la commande mvn test.
